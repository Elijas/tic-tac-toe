...
if playerNo == 1
    ...
    else if player1_nn_lsizes(1)==18, nn_input = [(gameState==playerNo)(:); (gameState==3-playerNo)(:)]';
    else if player1_nn_lsizes(1)==27, nn_input = [(gameState==playerNo)(:); (gameState==3-playerNo)(:); (gameState==0)(:)]'; end end end
    
    %disp(reshape(nnFeedForward(player1_nn_params, player1_nn_lsizes, nn_input), 3, 3))
    ...
    else if player2_nn_lsizes(1)==18, nn_input = [(gameState==playerNo)(:); (gameState==3-playerNo)(:)]';
    else if player2_nn_lsizes(1)==27, nn_input = [(gameState==playerNo)(:); (gameState==3-playerNo)(:); (gameState==0)(:)]'; end end end
